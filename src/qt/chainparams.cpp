...
// Copyright (c) 2020-2024 The OsinPay developers
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("explorer.osinpaycoin.com");
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = { {230000, 14}, {INT_MAX, 1} };// 10% founder/dev fee forever
        ...
        consensus.nCollaterals = SmartnodeCollaterals(
          { {88720, 800000 * COIN},
            ...
            {354720, 1900000 * COIN},
            {414720, 2100000 * COIN},
            {INT_MAX, 2400000 * COIN}
          },
          { {5040, 0}, {230000, 58}, {INT_MAX, 50} }
        );
