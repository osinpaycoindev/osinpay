...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
    ...
    if (nPrevHeight < 10) {
        nSubsidy = 30; 
    } else if ((nPrevHeight > 400000) && (nPrevHeight < 800000)) {
        nSubsidy = 2600; 
    } else if ((nPrevHeight > 800000) && (nPrevHeight < 1200000)) {
        nSubsidy = 2400;
    } else if ((nPrevHeight > 1200000) && (nPrevHeight < 1600000)) {
        nSubsidy = 2000;
    } else if ((nPrevHeight > 1600000) && (nPrevHeight < 2000000)) {
        nSubsidy = 1800;     
    } else if ((nPrevHeight > 2000000) && (nPrevHeight < 2400000)) {
        nSubsidy = 1400;      
    } else if ((nPrevHeight > 2400000) && (nPrevHeight < 2800000)) {
        nSubsidy = 1200;     
    } else if ((nPrevHeight > 2800000) && (nPrevHeight < 3200000)) {
        nSubsidy = 800;  
    } else if ((nPrevHeight > 3200000) && (nPrevHeight < 4000000)) {
        nSubsidy = 600;      
        ...
        nSubsidy = 60;      
    } else if ((nPrevHeight > 15000000) && (nPrevHeight < 20000000)) {
        nSubsidy = 40;     
    } else if ((nPrevHeight > 20000000) && (nPrevHeight < 25000000)) {
        nSubsidy = 20; 
    } else if (nPrevHeight > 25000000) {
        nSubsidy = 8.40;
    }
